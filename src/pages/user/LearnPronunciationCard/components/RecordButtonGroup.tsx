  ...
  return (
    <>
      {!isRecording && !isRecorded && (
        <button
        type="button"
        className="w-[336px] text-sm px-6 py-2 rounded-lg font-semibold shadow transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 bg-blue-600 text-white hover:bg-blue-700"
        tabIndex={0}
        onClick={onStart}
    ...
    {isRecording && (
      <button
        type="button"
        className="w-[336px] text-sm px-6 py-2 rounded-lg font-semibold shadow transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 bg-red-500 text-white"
        tabIndex={0}
        onClick={onStop}
