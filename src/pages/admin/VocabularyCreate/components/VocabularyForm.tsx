...
const VocabularyForm: React.FC<VocabularyFormProps> = ({ onSubmit, isSubmitting }) => {
  ...
  const handleClearAudio = () => {
    form.setValue("audio", "", { shouldValidate: true });
    form.setValue("audioFile", undefined, { shouldValidate: true });
    setFileName("");
