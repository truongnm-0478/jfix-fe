...
interface SpeakingQuestionFiltersProps {
  filters: SpeakingQuestionQueryParams;
  setFilters: React.Dispatch<React.SetStateAction<SpeakingQuestionQueryParams>>;
  totalRecords: number;
        ...
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-center">
            <div className="text-sm text-gray-500">
              {t("common.showing")} {speakingQuestionCount} {t("common.of")} {totalRecords}
            </div>
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col space-y-1.5">
                  <Label htmlFor="keyword">{t("adminSpeakingQuestion.keyword")}</Label>
                  <div className="flex items-center gap-2">
                    <Input
                      ...
                      placeholder={t("adminSpeakingQuestion.searchPlaceholder")}
                    />
                  </div>
                </div>
...
export default SpeakingQuestionFilters; 