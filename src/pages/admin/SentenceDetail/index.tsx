...
import { useAdminSentenceById, useDeleteSentence } from "@/hooks/useAdminSentence";
...
const AdminSentenceDetail: React.FC = () => {
  ...
  const { mutate: deleteSentenceMutation, isPending: isDeleting } = useDeleteSentence();
  ...
  if (isDeleting) {
    return <Loading message={t("adminSentence.deleting")} />
  }
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
        ...
        <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-2">
          <Button
            ...
            onClick={() => navigate(ROUTERS.ADMIN_SENTENCES_EDIT.replace(":id", id || ""))}
          >
...
export default AdminSentenceDetail; 