...
interface ParagraphFiltersProps {
  ...
  setFilters: React.Dispatch<React.SetStateAction<ParagraphQueryParams>>;
  totalRecords: number;
...
const ParagraphFilters = ({
  ...
  const applyFilters = () => {
    setFilters(prev => ({ 
      ...
      status: filterInputs.status === "all" ? undefined : filterInputs.status,
      page: 0,
    }));
        ...
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-center">
            <div className="text-sm text-gray-500">
              {t("common.showing")} {paragraphCount} {t("common.of")} {totalRecords}
            </div>
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col space-y-1.5">
                  <Label htmlFor="keyword">{t("adminParagraph.keyword")}</Label>
                  <div className="flex items-center gap-2">
                    <Input
                      ...
                      placeholder={t("adminParagraph.searchPlaceholder")}
                    />
                  </div>
                </div>
...
export default ParagraphFilters; 